...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {DB_PTREE, "rocksdb.db.ptree"},
    {DB_PTREELOCK_C, "rocksdb.db.ptreelock.create"},
    {DB_PTREELOCK_D, "rocksdb.db.ptreelock.destroy"},
    {DB_PTREELOCK_S, "rocksdb.db.ptreelock.setroot"},
    {DB_PTREELOCK_I, "rocksdb.db.ptreelock.insert"},
    {DB_PTREELOCK_SE, "rocksdb.db.ptreelock.search"},
    {DB_PTREELOCK_SES, "rocksdb.db.ptreelock.searches"},
    {DB_PTREELOCK_G, "rocksdb.db.ptreelock.getchild"},
