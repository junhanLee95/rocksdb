...
std::shared_ptr<MergeOperator> MergeOperators::CreateBluestoreOperator() {
  return std::make_shared<BluestoreOperator>();
}

bool BluestoreOperator::Merge(const Slice& /*key*/,
...
void BluestoreOperator::XOR(const Slice* existing_value,
