...
class SplitJob {
 public:
  ...
  // no copy/move
  SplitJob(SplitJob&& job) = delete;
  SplitJob(const SplitJob& job) = delete;
  SplitJob& operator=(const SplitJob& job) = delete;
 ...
 private:
  ...
  void ReportStartedSplit(Compaction* compaction);
  void AllocateSplitOutputFileNumbers();
  // Call compaction filter. Then iterate through input and compact the
  // kv-pairs
  void ProcessKeyValueSplit(SubsplitState* sub_compact);

  Status FinishSplitOutputFile(
  ...
  void RecordDroppedKeys(const CompactionIterationStats& c_iter_stats,
                         SplitJobStats* split_job_stats = nullptr);

  void UpdateSplitStats();
  void UpdateSplitInputStatsHelper(
