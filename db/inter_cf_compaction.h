...
class InterCFCompaction {
 public:
  InterCFCompaction(VersionStorageInfo* input_version,
             const ImmutableCFOptions& immutable_cf_options,
             const MutableCFOptions& mutable_cf_options,
             std::vector<InterCFCompactionInputFiles> inputs, int output_level,
  ...
  // No copying allowed
  InterCFCompaction(const InterCFCompaction&) = delete;
  void operator=(const InterCFCompaction&) = delete;
  ...
  const std::vector<InterCFCompactionInputFiles>* inputs() { return &inputs_; }
  ...
  const char* InputLevelSummary(InterCFInputLevelSummaryBuffer* scratch) const;
 ...
 private:
  ...
  static std::vector<InterCFCompactionInputFiles> PopulateWithAtomicBoundaries(
  ...
  const std::vector<InterCFCompactionInputFiles> inputs_;
