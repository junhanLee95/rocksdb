...
class LCFIterator : public InternalIterator {
 public:
  ...
  void SeekForPrev(const Slice& /*target*/) override {
    status_ = Status::NotSupported("LCFIterator::SeekForPrev()");
    valid_ = false;
  }
  void SeekToLast() override {
    status_ = Status::NotSupported("LCFIterator::SeekToLast()");
    valid_ = false;
  }
  void Prev() override {
    status_ = Status::NotSupported("LCFIterator::Prev");
    valid_ = false;
  }
