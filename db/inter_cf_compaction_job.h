...
class InterCFCompactionJob {
  ...
  */
  InterCFCompactionJob(int job_id, InterCFCompaction* inter_cf_compaction,
                const ImmutableDBOptions& db_options,
                const EnvOptions env_options, VersionSet* versions,
                const std::atomic<bool>* shutting_down,
                const SequenceNumber preserve_deletes_seqnum,
  ...
  // no copy/move
  InterCFCompactionJob(InterCFCompactionJob&& job) = delete;
  InterCFCompactionJob(const InterCFCompactionJob& job) = delete;
  InterCFCompactionJob& operator=(const InterCFCompactionJob& job) = delete;
 ...
 private:
  ...
  void ReportStartedCompaction(InterCFCompaction* compaction);
  void AllocateCompactionOutputFileNumbers();
  // Call compaction filter. Then iterate through input and compact the
  // kv-pairs
  void ProcessKeyValueCompaction(SubInterCFcompactionState* sub_compact);
  ...
  // CompactionJob state
  struct InterCFCompactionState;
  InterCFCompactionState* compact_;
