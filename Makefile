...
CEPH_LIBOBJECTS = ${CEPH_HOME}/build/src/common/CMakeFiles/common-common-objs.dir/ceph_crypto.cc.o \
		  ...
		  ${CEPH_HOME}/build/src/arch/CMakeFiles/arch.dir/*.o \
		  ${CEPH_HOME}/build/src/kv/CMakeFiles/kv.dir/*.cc.o \
		  ${CEPH_HOME}/build/src/kv/CMakeFiles/kv.dir/*/*.cc.o \
		  ${CEPH_HOME}/build/src/json_spirit/CMakeFiles/json_spirit.dir/json_spirit_reader.cpp.o \
 		  ${CEPH_HOME}/build/src/json_spirit/CMakeFiles/json_spirit.dir/json_spirit_writer.cpp.o 

CLEAN_FILES = # deliberately empty, so we can append below.
CFLAGS += ${EXTRA_CFLAGS} ${JAVA_INCLUDE} ${CEPH_INCLUDE}
CXXFLAGS += ${EXTRA_CXXFLAGS} ${JAVA_INCLUDE} ${CEPH_INCLUDE} 
LDFLAGS += $(EXTRA_LDFLAGS) -L ${CEPH_HOME}/build/lib -L ${CEPH_HOME}/bulid/boost/lib
...
bluefs_test: fs/bluefs_test.o $(CEPH_LIBOBJECTS) $(LIBOBJECTS) $(TESTHARNESS)
	$(AM_LINK) $(CEPH_LIBRARY)
#-------------------------------------------------
